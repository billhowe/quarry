...
#Get the next line which is based on itur
	...
	if ($itur == 0) {
		...
		$nvdt[0] = "bgdiff" ;
		$nvdt[1] = $tmpLine[0] ;
		$nvdt[2] = "Background Diffusitivity" ;
		$nvdt[3] = "float" ;
		AddItem (@nvdt); 

		$nvdt[0] = "diff_max" ;
		$nvdt[1] = $tmpLine[1] ;
		$nvdt[2] = "Maximum Diffusitivity" ;
		$nvdt[3] = "float" ;
		AddItem (@nvdt); 
	
		$nvdt[0] = "hest_my" ;
		$nvdt[1] = $tmpLine[2] ;
		$nvdt[2] = "Cut depth for estuary" ;
		$nvdt[3] = "float" ;
		AddItem (@nvdt); 
		...
		$nvdt[0] = "xmlmin_est" ;
		$nvdt[1] = $tmpLine[4] ;
		$nvdt[2] = "Minimum Mixing Length for estuary" ;
		$nvdt[3] = "float" ;
		AddItem (@nvdt); 

		$nvdt[0] = "xmlmin_sea" ;
		$nvdt[1] = $tmpLine[5] ;
		$nvdt[2] = "Minimum Mixing Length for open sea" ;
		$nvdt[3] = "float" ;
		AddItem (@nvdt); 
	}
...
# Get  wind stresses
	...
	chomp($str) ;
	@tmpLine = split(/\s/,$str) ;
	$nvdt[0] = "out_wind_stresses" ;
	$nvdt[1] = $tmpLine[0] ;
	$nvdt[2] = "output option for wind stresses" ;
	$nvdt[3] = "integer" ;
	AddItem (@nvdt) ;
...
# Get isolver, itmax1, iremove, zeta, tol
	$str = <pHandle> ;
	chomp($str) ;
	@tmpLine = split (/\s/,$str) ;
	$nvdt[0] = "isolver" ;
